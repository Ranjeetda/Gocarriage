...
class _BasicDetailsFormState extends State<BasicDetailsForm> {
  ...
  Future<void> _updateProfile() async {
    print("RanjeetTesting ======profilePhotoUrl=====>${profilePhotoUrl}");
    print("RanjeetTesting ======panDocumentUrl=====>${panDocumentUrl}");
    print("RanjeetTesting =======gstCertificateUrl====>${gstCertificateUrl}");
    ...
    if (response != null && response['success'] == true) {
      ...
      setState(() {
        if (mType == "Profile Photo") {
          ...
          print("RanjetTest====profilePhotoUrl=====>${profilePhotoUrl}");
        } else if (mType == "PAN Document") {
          panDocumentUrl = fileKey;
          print("RanjetTest====panDocumentUrl=====>${panDocumentUrl}");

        } else if (mType == "GST Certificate") {
          gstCertificateUrl = fileKey;
          print("RanjetTest====gstCertificateUrl=====>${gstCertificateUrl}");
            ...
            child: Form(
              ...
              child: Consumer<ProfileProvider>(
                builder: (context, profileProvider, child) {
                  ...
                  if (!_isDataInitialized && data.isNotEmpty) {
  ...
  Future<void> _pickFromSource(
    ...
    if (pickedFile != null) {
      ...
      _fileUpload('customers', file, fileType); // your API call
    }
  }
