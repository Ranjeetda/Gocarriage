...
import '../screens/model/bluk_booking_trip_request.dart';
import 'URLS.dart';

class BlukBookingTripProvider with ChangeNotifier {

  Future<http.Response> blukBookingTrip(
      BlukBookingTripRequest bookingRequest) async {
